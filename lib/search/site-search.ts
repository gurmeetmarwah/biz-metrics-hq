...
const industryKeywords: Record<string, string[]> = {
  ...
  "Veterinary Clinic": ["vet", "veterinary", "animal", "vet clinic profit margin"],
  ...
  Plumbing: ["plumber", "plumbing", "plumbing profit margin", "plumbing owner salary"],
  ...
  "Cleaning Business": ["cleaning", "janitorial", "maid", "cleaning business profit margin"],
