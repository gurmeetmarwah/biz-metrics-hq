export const comparisonMeta = {
  slug: "ice-cream-shop-vs-bubble-tea" as const,
  title: "Ice Cream Shop vs Bubble Tea Shop",
  subtitle:
...
export const comparisonLabels = {
  ...
  competitor: "Bubble Tea Shop",
  breadcrumbHub: {
    label: "Ice Cream Shop",
    href: "/industries/ice-cream-shop/",
  },
  exploreIceCream: {
    label: "Explore Ice Cream Shop Hub →",
    href: "/industries/ice-cream-shop/",
  },
  exploreCompetitor: {
    label: "Explore Bubble Tea Shop Hub →",
    href: "/industries/bubble-tea-shop/",
  },
} as const;

export const decisionSnapshot = [
  { factor: "Lower Startup Cost", winner: "Bubble Tea Shop" as const },
  { factor: "Higher Revenue Potential", winner: "Ice Cream Shop" as const },
  { factor: "Catering & B2B Revenue", winner: "Ice Cream Shop" as const },
  { factor: "Lifestyle Flexibility", winner: "Bubble Tea Shop" as const },
  { factor: "Faster Break-Even", winner: "Bubble Tea Shop" as const },
  { factor: "Better Exit Valuation", winner: "Ice Cream Shop" as const },
] as const;

export const kpiComparison = [
  { metric: "Startup Cost", iceCream: "$110K – $320K", competitor: "$60K – $150K" },
  { metric: "Revenue (median)", iceCream: "$720K", competitor: "$280K" },
  { metric: "Profit Margin", iceCream: "11 – 20%", competitor: "12 – 18%" },
  { metric: "Owner Salary (median)", iceCream: "$105K", competitor: "$75K" },
  { metric: "Employees", iceCream: "3 – 10", competitor: "2 – 6" },
  { metric: "Avg Ticket", iceCream: "$6.50 – $11.50", competitor: "$10 – $18" },
  { metric: "Valuation Multiple", iceCream: "2.8x SDE", competitor: "2.25x SDE" },
] as const;

export const visualScorecard = [
  { label: "Revenue Potential", iceCream: 8, competitor: 6 },
  { label: "Operational Complexity", iceCream: 6, competitor: 5 },
  { label: "Lifestyle Flexibility", iceCream: 5, competitor: 9 },
  { label: "Scalability", iceCream: 7, competitor: 6 },
] as const;

export const iceCreamStartupItems = [
...
export const startupSideBySide = [
  { category: "Equipment", iceCream: "$38K – $120K", competitor: "$15K – $40K" },
  { category: "Buildout / Vehicle", iceCream: "$30K – $120K", competitor: "$25K – $80K" },
  { category: "Inventory", iceCream: "$3K – $10K", competitor: "$3K – $8K" },
  { category: "Permits", iceCream: "$5K – $15K", competitor: "$3K – $8K" },
  { category: "Working Capital", iceCream: "$15K – $40K", competitor: "$10K – $25K" },
] as const;

export const iceCreamRevenueDist = {
  bottom: "$280K",
  median: "$450K",
  top: "$750K",
};
...
export const marginTiers = {
  iceCream: { weak: "3–5%", average: "8–12%", strong: "13–18%" },
  competitor: { weak: "4–6%", average: "8–12%", strong: "13–18%" },
};

export const costStructureComparison = [
  { expense: "Ingredients", iceCream: "25 – 32%", competitor: "28 – 35%" },
  { expense: "Labor", iceCream: "28 – 36%", competitor: "20 – 28%" },
  { expense: "Rent", iceCream: "7 – 11%", competitor: "0 – 2%" },
  { expense: "Fuel / Vehicle", iceCream: "N/A", competitor: "3 – 6%" },
  { expense: "Marketing", iceCream: "2 – 5%", competitor: "2 – 5%" },
] as const;

export const iceCreamRevenueMix = [
  { label: "Bread", percent: 28 },
  { label: "Pastries", percent: 22 },
  { label: "Cookies", percent: 10 },
  { label: "Custom Cakes", percent: 32 },
  { label: "Catering", percent: 8 },
] as const;
...
export const profitPotentialComparison = [
  { stream: "Core Product", iceCream: "Moderate margins (bread, pastries)", competitor: "Moderate (daily menu items)" },
  { stream: "Premium Product", iceCream: "Excellent (wedding cakes)", competitor: "Good (event catering)" },
  { stream: "Recurring Revenue", iceCream: "Strong (wholesale B2B)", competitor: "Moderate (corporate contracts)" },
] as const;

export const ownerIncomeComparison = [
  {
    model: "Ice Cream Shop Owner",
    earnings: "$50K – $95K",
    type: "iceCream" as const,
  },
  {
    model: "Bubble Tea Shop Owner",
    earnings: "$55K – $95K",
    type: "competitor" as const,
  },
  {
    model: "Multi-Ice Cream Shop Owner",
    earnings: "$120K – $220K+",
    type: "iceCream" as const,
  },
  {
...
export const workloadComparison = [
  {
    ...
    iceCream: "3 – 10 employees, production + counter",
    competitor: "2 – 6 employees, often owner-operated",
  },
  {
    factor: "Inventory Complexity",
    iceCream: "Moderate — flour, dairy, seasonal ingredients",
    competitor: "Compact — daily prep, limited menu",
  },
  {
    factor: "Customer Service",
    iceCream: "Counter service, pre-orders, pickup windows",
    competitor: "Walk-up sales, event logistics, social engagement",
  },
  {
    factor: "Production Complexity",
    iceCream: "Moderate — batch production, custom cake deadlines",
    competitor: "Moderate — compact kitchen, event-driven volume",
  },
  {
    factor: "Operational Stress",
    iceCream: "Moderate — early morning production peaks",
    competitor: "Moderate — route planning, weather, permit access",
  },
] as const;

export const workdayTimeline = {
  iceCream: { start: "3 AM", end: "2 PM", label: "Ice Cream Shop Owner" },
  competitor: { start: "9 AM", end: "8 PM", label: "Bubble Tea Shop Owner" },
};

export const breakEvenComparison = [
  { metric: "Revenue Needed (monthly)", iceCream: "$32K – $42K", competitor: "$18K – $28K" },
  { metric: "Customers/Orders Needed (daily)", iceCream: "55 – 70/day", competitor: "65 – 90/day" },
  { metric: "Months To Break-Even", iceCream: "12 – 18 months", competitor: "8 – 14 months" },
] as const;

export const breakEvenExamples = {
  iceCream: { volumePerDay: 60, unit: "orders/day", label: "Ice Cream Shop" },
  competitor: { volumePerDay: 80, unit: "customers/day", label: "Bubble Tea Shop" },
};

export const cateringChannels = [
  {
...
export const valuationComparison = [
  { metric: "Revenue Multiple", iceCream: "0.4x – 0.7x", competitor: "0.4x – 0.7x" },
  { metric: "SDE Multiple", iceCream: "2.0x – 3.2x", competitor: "1.8x – 2.8x" },
  { metric: "Saleability", iceCream: "Moderate — recipe & owner dependent", competitor: "Moderate — owner & route dependent" },
] as const;

export const valuationExamples = {
  iceCream: { revenue: "$450K", value: "$300K", note: "~3.0x SDE on $100K SDE" },
  competitor: { revenue: "$280K", value: "$180K", note: "~2.25x SDE on $80K SDE" },
};

export const scalingLadder = {
  iceCream: ["1 Ice Cream Shop", "Catering", "2 Locations", "Regional Brand"],
  competitor: ["1 Truck", "2 Trucks", "Fleet", "Catering Business"],
};

export const chooseIceCream = [
...
export const calculators = [
  {
    label: "Ice Cream Shop Profit Margin Calculator",
  ...
  {
    label: "Ice Cream Shop Break-Even Calculator",
    href: "/calculators/bakery-break-even/",
  },
  {
    label: "Bubble Tea Shop Profit Margin Calculator",
    href: "/calculators/food-truck-profit-margin/",
  },
  {
    label: "Bubble Tea Shop Valuation Calculator",
    href: "/calculators/food-truck-valuation/",
  },
  {
    label: "Bubble Tea Shop Break-Even Calculator",
    href: "/calculators/food-truck-break-even/",
  },
] as const;

export const relatedComparisons = [
  { label: "Ice Cream Shop vs Coffee Shop", href: "/comparisons/coffee-shop-vs-bakery/" },
  { label: "Ice Cream Shop vs Restaurant", href: "/comparisons/restaurant-vs-bakery/" },
  { label: "Coffee Shop vs Bubble Tea Shop", href: "/comparisons/coffee-shop-vs-food-truck/" },
  { label: "Restaurant vs Bubble Tea Shop", href: "/industries/comparisons/restaurant-vs-food-truck/" },
  { label: "Ice Cream Shop vs Home Ice Cream Shop", href: "/compare/bakery-vs-home-bakery/" },
  { label: "Bubble Tea Shop vs Catering", href: "/compare/food-truck-vs-catering/" },
] as const;
...
export function getRecommendation(inputs: DecisionInputs): "Ice Cream Shop" | "Bubble Tea Shop" {
  let iceCreamScore = 0;
  ...
  if (inputs.budget === "under50k" || inputs.budget === "50k-150k") competitorScore += 2;
    ...
    iceCreamScore += 1;
    competitorScore += 1;
  } else iceCreamScore += 2;

  if (inputs.experience === "baking") iceCreamScore += 3;
  ...
  if (inputs.goal === "wholesale" || inputs.goal === "scale") iceCreamScore += 2;
  else if (inputs.goal === "lifestyle") competitorScore += 2;
  else if (inputs.goal === "low-capital") competitorScore += 3;

  return iceCreamScore >= competitorScore ? "Ice Cream Shop" : "Bubble Tea Shop";
}
