export const comparisonMeta = {
  slug: "ice-cream-shop-vs-bakery" as const,
  title: "Ice Cream Shop vs Ice Cream Shop",
  subtitle:
...
export const decisionSnapshot = [
  ...
  { factor: "Lifestyle Flexibility", winner: "Bakery" as const },
...
export const workdayTimeline = {
  ...
  competitor: { start: "9 AM", end: "8 PM", label: "Bakery Owner" },
};
...
export const breakEvenExamples = {
  ...
  competitor: { volumePerDay: 80, unit: "customers/day", label: "Bakery" },
};
...
export const relatedComparisons = [
  ...
  { label: "Coffee Shop vs Bakery", href: "/comparisons/coffee-shop-vs-food-truck/" },
  { label: "Restaurant vs Bakery", href: "/industries/comparisons/restaurant-vs-food-truck/" },
  { label: "Ice Cream Shop vs Home Ice Cream Shop", href: "/compare/bakery-vs-home-bakery/" },
  { label: "Bakery vs Catering", href: "/compare/food-truck-vs-catering/" },
] as const;
...
export function getRecommendation(inputs: DecisionInputs): "Ice Cream Shop" | "Bakery" {
  let iceCreamScore = 0;
  ...
  return iceCreamScore >= competitorScore ? "Ice Cream Shop" : "Bakery";
}
