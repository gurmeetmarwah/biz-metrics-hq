export const comparisonMeta = {
  slug: "ice-cream-shop-vs-dessert-cafe" as const,
  title: "Ice Cream Shop vs Dessert Cafe",
  subtitle:
...
export const comparisonLabels = {
  ...
  exploreCompetitor: {
    label: "Explore Dessert Cafe Hub →",
    href: "/industries/dessert-cafe/",
  },
} as const;

export const decisionSnapshot = [
  { factor: "Lower Startup Cost", winner: "Dessert Cafe" as const },
  { factor: "Higher Revenue Potential", winner: "Ice Cream Shop" as const },
  { factor: "Catering & B2B Revenue", winner: "Ice Cream Shop" as const },
  { factor: "Lifestyle Flexibility", winner: "Dessert Cafe" as const },
  { factor: "Faster Break-Even", winner: "Dessert Cafe" as const },
...
export const workdayTimeline = {
  ...
  competitor: { start: "9 AM", end: "8 PM", label: "Dessert Cafe Owner" },
};
...
export const breakEvenExamples = {
  ...
  competitor: { volumePerDay: 80, unit: "customers/day", label: "Dessert Cafe" },
};
...
export const calculators = [
  ...
  {
    label: "Dessert Cafe Profit Margin Calculator",
    href: "/calculators/food-truck-profit-margin/",
  },
  {
    label: "Dessert Cafe Valuation Calculator",
    href: "/calculators/food-truck-valuation/",
  },
  {
    label: "Dessert Cafe Break-Even Calculator",
...
export const relatedComparisons = [
  ...
  { label: "Coffee Shop vs Dessert Cafe", href: "/comparisons/coffee-shop-vs-food-truck/" },
  { label: "Restaurant vs Dessert Cafe", href: "/industries/comparisons/restaurant-vs-food-truck/" },
  { label: "Ice Cream Shop vs Home Ice Cream Shop", href: "/compare/bakery-vs-home-bakery/" },
  { label: "Dessert Cafe vs Catering", href: "/compare/food-truck-vs-catering/" },
] as const;
...
export function getRecommendation(inputs: DecisionInputs): "Ice Cream Shop" | "Dessert Cafe" {
  let iceCreamScore = 0;
  ...
  return iceCreamScore >= competitorScore ? "Ice Cream Shop" : "Dessert Cafe";
}
