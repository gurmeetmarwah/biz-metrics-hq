export const comparisonMeta = {
  slug: "ice-cream-shop-vs-frozen-yogurt" as const,
  title: "Ice Cream Shop vs Frozen Yogurt",
  subtitle:
...
export const comparisonLabels = {
  ...
  exploreCompetitor: {
    label: "Explore Frozen Yogurt Hub →",
    href: "/industries/frozen-yogurt-shop/",
  },
} as const;

export const decisionSnapshot = [
  { factor: "Lower Startup Cost", winner: "Frozen Yogurt" as const },
  { factor: "Higher Revenue Potential", winner: "Ice Cream Shop" as const },
  { factor: "Catering & B2B Revenue", winner: "Ice Cream Shop" as const },
  { factor: "Lifestyle Flexibility", winner: "Frozen Yogurt" as const },
  { factor: "Faster Break-Even", winner: "Frozen Yogurt" as const },
...
export const workdayTimeline = {
  ...
  competitor: { start: "9 AM", end: "8 PM", label: "Frozen Yogurt Owner" },
};
...
export const breakEvenExamples = {
  ...
  competitor: { volumePerDay: 80, unit: "customers/day", label: "Frozen Yogurt" },
};
...
export const calculators = [
  ...
  {
    label: "Frozen Yogurt Profit Margin Calculator",
    href: "/calculators/food-truck-profit-margin/",
  },
  {
    label: "Frozen Yogurt Valuation Calculator",
    href: "/calculators/food-truck-valuation/",
  },
  {
    label: "Frozen Yogurt Break-Even Calculator",
...
export const relatedComparisons = [
  ...
  { label: "Coffee Shop vs Frozen Yogurt", href: "/comparisons/coffee-shop-vs-food-truck/" },
  { label: "Restaurant vs Frozen Yogurt", href: "/industries/comparisons/restaurant-vs-food-truck/" },
  { label: "Ice Cream Shop vs Home Ice Cream Shop", href: "/compare/bakery-vs-home-bakery/" },
  { label: "Frozen Yogurt vs Catering", href: "/compare/food-truck-vs-catering/" },
] as const;
...
export function getRecommendation(inputs: DecisionInputs): "Ice Cream Shop" | "Frozen Yogurt" {
  let iceCreamScore = 0;
  ...
  return iceCreamScore >= competitorScore ? "Ice Cream Shop" : "Frozen Yogurt";
}
