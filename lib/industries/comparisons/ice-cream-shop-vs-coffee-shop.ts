export const comparisonMeta = {
  slug: "ice-cream-shop-vs-coffee-shop" as const,
  title: "Ice Cream Shop vs Coffee Shop",
  subtitle:
...
export const decisionSnapshot = [
  ...
  { factor: "Lifestyle Flexibility", winner: "Coffee Shop" as const },
  { factor: "Faster Break-Even", winner: "Coffee Shop" as const },
  { factor: "Better Exit Valuation", winner: "Ice Cream Shop" as const },
] as const;

export const kpiComparison = [
  { metric: "Startup Cost", iceCream: "$110K – $320K", competitor: "$80K – $400K" },
  { metric: "Revenue (median)", iceCream: "$720K", competitor: "$550K" },
  { metric: "Profit Margin", iceCream: "11 – 20%", competitor: "10 – 18%" },
  { metric: "Owner Salary (median)", iceCream: "$105K", competitor: "$85K" },
  { metric: "Employees", iceCream: "4 – 12", competitor: "4 – 10" },
  { metric: "Avg Ticket", iceCream: "$6.50 – $11.50", competitor: "$6 – $12" },
  { metric: "Valuation Multiple", iceCream: "2.8× SDE", competitor: "2.5× SDE" },
] as const;
...
export const workdayTimeline = {
  ...
  competitor: { start: "9 AM", end: "8 PM", label: "Coffee Shop Owner" },
};
...
export const breakEvenExamples = {
  ...
  competitor: { volumePerDay: 80, unit: "customers/day", label: "Coffee Shop" },
};
...
export const relatedComparisons = [
  ...
  { label: "Coffee Shop vs Coffee Shop", href: "/comparisons/coffee-shop-vs-food-truck/" },
  { label: "Restaurant vs Coffee Shop", href: "/industries/comparisons/restaurant-vs-food-truck/" },
  { label: "Ice Cream Shop vs Home Ice Cream Shop", href: "/compare/bakery-vs-home-bakery/" },
  { label: "Coffee Shop vs Catering", href: "/compare/food-truck-vs-catering/" },
] as const;
...
export function getRecommendation(inputs: DecisionInputs): "Ice Cream Shop" | "Coffee Shop" {
  let iceCreamScore = 0;
  ...
  return iceCreamScore >= competitorScore ? "Ice Cream Shop" : "Coffee Shop";
}
