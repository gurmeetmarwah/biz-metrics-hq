...
export const meta = {
  title: "Day Spa Treatment Room Utilization Calculator — Occupancy & Idle Capacity",
  ...
  description:
    "Free day spa treatment room utilization calculator. Measure room occupancy, idle hours, and the revenue upside of reaching target utilization.",
};

export const introContent = {
  lead: "Treatment room utilization shows how much of your spa's available capacity is actually booked. This calculator finds idle hours and the revenue upside of filling them.",
  bullets: [
    "Utilization = Booked Room Hours ÷ Available Room Hours × 100",
    "Target 60–78% utilization on optimized schedules",
    "Idle room time is lost revenue you can recover with better scheduling",
  ],
  audience: "Built for day spa owners optimizing scheduling and room productivity.",
};
...
export const defaultInputs: UtilizationInputs = {
  ...
  bookedHoursPerRoomPerWeek: 35,
  revenuePerBookedHour: 87,
};

export const industryBenchmarks = [
  { metric: "Room Utilization", range: "60 – 78%" },
  { metric: "Revenue per Booked Hour", range: "$70 – $120" },
  { metric: "Available Hours / Room", range: "45 – 55 / week" },
  { metric: "Idle Capacity Target", range: "< 35%" },
] as const;
...
export function calculateUtilization(inputs: UtilizationInputs) {
  ...
  const targetBookedHours = availableRoomHours * 0.78;
  ...
  else if (utilization >= 78) status = "high";
...
export const faqs = [
  {
    question: "What is a good treatment room utilization rate for a day spa?",
    answer:
      "A healthy day spa room utilization rate is 60–78%. Below 60% usually means idle capacity and lost revenue; consistently above 78% may signal you need more rooms or therapists to meet demand.",
  },
  {
    question: "How do I improve day spa treatment room utilization?",
    answer:
...
export const relatedTools = relatedCalculators("/calculators/day-spa-treatment-room-utilization/");
