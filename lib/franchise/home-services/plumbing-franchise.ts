...
export const plumbingFranchiseGuide: HomeServicesFranchiseGuideData = {
  meta: {
    ...
    shortName: "Plumbing",
    title: "Best Plumbing Franchises 2026: Costs, ROI & Top Brands",
    subtitle:
      "Compare the best plumbing franchises — Mr. Rooter, Benjamin Franklin, Roto-Rooter, and Rooter-Man. See startup costs, fees, royalties, margins, and ROI before you buy.",
    ...
    overviewTitle: "Best Plumbing Franchises — Which Brand Fits You?",
    ...
    compareTitle: "Compare the Best Plumbing Franchises Side by Side",
