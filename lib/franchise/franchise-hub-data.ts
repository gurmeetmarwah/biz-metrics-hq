...
export const franchiseCategories: readonly FranchiseCategory[] = [
  ...
  },
  {
    ...
    franchises: [
      { label: "HVAC Franchise", slug: "hvac-franchise", href: franchiseHref("home-services", "hvac-franchise"), comingSoon: true },
      { label: "Plumbing Franchise", slug: "plumbing-franchise", href: franchiseHref("home-services", "plumbing-franchise"), comingSoon: true },
      { label: "Electrical Franchise", slug: "electrical-franchise", href: franchiseHref("home-services", "electrical-franchise"), comingSoon: true },
      { label: "Roofing Franchise", slug: "roofing-franchise", href: franchiseHref("home-services", "roofing-franchise"), comingSoon: true },
      { label: "Landscaping Franchise", slug: "landscaping-franchise", href: franchiseHref("home-services", "landscaping-franchise"), comingSoon: true },
      { label: "Cleaning Franchise", slug: "cleaning-franchise", href: franchiseHref("home-services", "cleaning-franchise"), comingSoon: true },
      { label: "Pest Control Franchise", slug: "pest-control-franchise", href: franchiseHref("home-services", "pest-control-franchise"), comingSoon: true },
    ],
  },
  {
    id: "fitness",
    ...
    franchises: [
      { label: "Gym Franchise", slug: "gym-franchise", href: franchiseHref("fitness", "gym-franchise"), comingSoon: true },
      { label: "Pilates Franchise", slug: "pilates-franchise", href: franchiseHref("fitness", "pilates-franchise"), comingSoon: true },
      { label: "Yoga Franchise", slug: "yoga-franchise", href: franchiseHref("fitness", "yoga-franchise"), comingSoon: true },
      { label: "CrossFit Affiliate", slug: "crossfit-affiliate", href: franchiseHref("fitness", "crossfit-affiliate"), comingSoon: true },
      { label: "Martial Arts Franchise", slug: "martial-arts-franchise", href: franchiseHref("fitness", "martial-arts-franchise"), comingSoon: true },
      { label: "Swim School Franchise", slug: "swim-school-franchise", href: franchiseHref("fitness", "swim-school-franchise"), comingSoon: true },
    ],
  },
  {
    id: "healthcare",
