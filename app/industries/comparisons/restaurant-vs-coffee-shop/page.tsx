...
import { RestaurantVsCoffeeShopDecisionTool } from "@/components/comparison/RestaurantVsCoffeeShopDecisionTool";
import {
  breakEvenComparison,
  breakEvenExamples,
  calculators,
...
export const metadata: Metadata = {
  ...
  description:
    "Restaurant vs coffee shop comparison: startup costs, revenue, profit margins, workload, break-even, owner income, valuation, and interactive decision tool.",
};
...
function DailyEconomicsCard({
  ...
  title: string;
  data: { customersPerDay: number; averageTicket: number; dailyRevenue: number };
  accentClass: string;
}) {
  const rows = [
    { metric: "Customers/Day", value: data.customersPerDay.toLocaleString() },
    { metric: "Average Ticket", value: `$${data.averageTicket.toFixed(2)}` },
    { metric: "Revenue/Day", value: `$${data.dailyRevenue.toLocaleString()}` },
  ];
        ...
        {[
          {
            ...
            startHour: restaurantStart,
            endHour: restaurantEnd,
            color: "bg-metric-margin",
          },
          {
            label: workdayTimeline.coffeeShop.label,
            start: workdayTimeline.coffeeShop.start,
            end: workdayTimeline.coffeeShop.end,
            startHour: coffeeStart,
            endHour: coffeeEnd,
          ...
          <div key={row.label}>
            ...
            <div className="relative mt-2 h-6 overflow-hidden rounded-full bg-surface-muted">
              <div
                ...
                style={{
                  left: `${((row.startHour - 6) / 17) * 100}%`,
                  width: `${((row.endHour - row.startHour) / 17) * 100}%`,
                }}
              />
            </div>
          </div>
...
export default function RestaurantVsCoffeeShopPage() {
  const faqJsonLd = {
    ...
    <>
      ...
      <main>
        <section className="hero-mesh border-b border-border/60">
          <div className="mx-auto max-w-4xl px-4 py-12 text-center sm:px-6 sm:py-16">
            ...
            >
              ...
              <span className="mx-2">/</span>
              <span className="text-ink-muted">Restaurant vs Coffee Shop</span>
            </nav>
        ...
        <Section
          ...
          subtitle="High-intent comparison of what it takes to open each business."
        >
        ...
        <Section
          ...
          subtitle="Restaurants win on total revenue; coffee shops win on capital efficiency."
        ...
        >
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            />
            <RevenueDistBar
              label="Coffee Shop Revenue"
              bottom={coffeeShopRevenueDist.bottom}
              median={coffeeShopRevenueDist.median}
              top={coffeeShopRevenueDist.top}
        ...
        <Section
          ...
          subtitle="How customer volume and average ticket translate to daily revenue."
        >
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <DailyEconomicsCard
              title="Restaurant Example"
              data={dailyEconomics.restaurant}
              accentClass="text-metric-margin"
            />
            <DailyEconomicsCard
              title="Coffee Shop Example"
              data={dailyEconomics.coffeeShop}
          ...
          <p className="mt-6 rounded-xl border border-border bg-surface-muted/30 px-5 py-4 text-sm text-ink-muted">
            <span className="font-semibold text-ink">Revenue formula:</span>{" "}
            Revenue = Customers × Average Ticket. Coffee shops use the same framework
            but with higher volume and lower ticket sizes.
          </p>
        </Section>
        ...
        <Section
          ...
          subtitle="A huge decision factor — many owners choose based on lifestyle, not just economics."
          className="bg-surface-muted/50"
        >
        ...
        >
          ...
          <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2">
            {[
              breakEvenExamples.restaurant,
              breakEvenExamples.coffeeShop,
            ].map((ex) => (
              <div
                key={ex.label}
              ...
              >
                ...
                <p className="mt-2 text-3xl font-bold tabular-nums text-accent">
                  {ex.customersPerDay} customers/day
                </p>
              </div>
            ))}
          </div>
        ...
        >
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            <div className="rounded-2xl border border-border bg-surface p-6">
              <p className="font-display font-semibold text-metric-salary">Coffee Shop</p>
        ...
        <Section
          ...
          title="Who Should Open What?"
          subtitle="High-engagement guidance based on capital, goals, and lifestyle."
          className="bg-surface-muted/50"
        >
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        >
          <RestaurantVsCoffeeShopDecisionTool />
        </Section>
