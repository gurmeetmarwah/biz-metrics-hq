...
} from "@/components/industry/RoofingIndustryPanels";
    ...
    <>
      ...
      <main>
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:items-start">
              ...
              <div id="benchmark">
                <IndustryBenchmarkTool
                  title="Benchmark Your Roofing Business"
                  thresholds={benchmarkThresholds}
                  defaults={benchmarkDefaults}
                  attribution={roofingAttribution}
                  technicianLabel="Install Crews"
        ...
        <HubSection
          ...
          title="Roofing Industry Insights"
          subtitle="What makes roofing economics different from service-based home trades."
        >
        ...
        <HubSection
          ...
          title="Average Roofing Company Revenue"
          subtitle="Annual revenue percentiles for owner-operated roofing companies."
        ...
        >
          ...
          <div className="mt-12">
            <RevenueMixPanel
              title="Revenue Mix"
              subtitle="Where roofing company revenue typically comes from — project-heavy with insurance restoration in storm markets."
              items={revenueMix}
            />
          </div>
        </HubSection>
        ...
        <HubSection
          id="profitability"
          title="Roofing Profit Margins"
          subtitle="Gross and net margin benchmarks for roofing contractors."
        >
        ...
        <HubSection
          id="owner-economics"
          title="How Much Do Roofing Business Owners Make?"
          subtitle="Owner compensation from solo operator to multi-city roofing brand."
          className="bg-surface-muted/50"
        >
        ...
        <HubSection
          id="valuation"
          title="Roofing Business Valuation Multiples"
          subtitle="SDE, EBITDA, and revenue multiples used to value roofing companies at sale."
        >
          ...
          <div className="mt-8">
            <IndustryValuationMiniTool
              title="Estimated Roofing Business Value"
        ...
        <HubSection
          id="top-performers"
          title="What Top Roofing Companies Do Differently"
          subtitle="Practices that separate high-performing roofing operators from the median."
          className="bg-surface-muted/50"
        >
          <div className="rounded-2xl border border-border bg-surface p-6 sm:p-8">
            <h3 className="font-display font-semibold text-ink">Top Roofing Companies Often:</h3>
        ...
        <HubSection id="opportunities-risks" title="Industry Outlook">
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border border-border bg-surface p-6 sm:p-8">
              <h3 className="font-display font-semibold text-ink">Growth Drivers</h3>
        ...
        <HubSection
          ...
          subtitle="Current industry drivers shaping roofing demand, costs, and crew availability."
          className="bg-surface-muted/50"
        >
          <MarketConditionsPanel
            title="Current Industry Drivers"
            subtitle="Contextual signals roofing operators monitor when planning growth and capacity."
            items={marketConditions}
          />
        </HubSection>

        <HubSection id="recurring-revenue" title="Recurring Revenue Score">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            <RecurringRevenueComparisonPanel
              title="Recurring Revenue Potential"
              subtitle="How roofing compares to service-based home trades — a key differentiator for business quality and valuation."
              items={recurringRevenueComparison}
            />
            <div className="rounded-2xl border border-border bg-surface p-6 sm:p-8">
              <h3 className="font-display font-semibold text-ink">Why This Matters</h3>
              <p className="mt-4 text-sm leading-relaxed text-ink-muted">
                Recurring revenue drives predictable cash flow, higher valuation multiples, and lower owner
                dependence. HVAC maintenance agreements can represent 25–45% of revenue; roofing maintenance
                typically runs 5–15%. This structural difference affects revenue stability, exit potential, and
                how investors compare roofing to other home service businesses.
              </p>
              <p className="mt-4 text-sm text-ink-muted">
                See comparisons:{" "}
                <Link href="/comparisons/hvac-vs-roofing/" className="text-accent hover:underline">
                  HVAC vs Roofing
                </Link>
                ,{" "}
                <Link href="/comparisons/plumbing-vs-roofing/" className="text-accent hover:underline">
                  Plumbing vs Roofing
                </Link>
              </p>
            </div>
        ...
        <HubSection
          id="business-quality"
          title="Business Quality Scorecard"
          subtitle="Quick assessment of typical roofing business characteristics."
          className="bg-surface-muted/50"
        >
        ...
        <HubSection
          id="insurance-claims"
          title="Insurance Claim Economics"
          subtitle="How insurance restoration revenue shapes roofing economics in storm markets."
        >
          <div className="overflow-hidden rounded-2xl border border-border bg-surface">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border-subtle bg-surface-muted/50">
                  ...
                  <th className="px-5 py-3.5 text-left font-semibold text-ink">Typical Range</th>
                  <th className="hidden px-5 py-3.5 text-left font-semibold text-ink sm:table-cell">Revenue Impact</th>
                  <th className="hidden px-5 py-3.5 text-left font-semibold text-ink lg:table-cell">Margin Impact</th>
                </tr>
              </thead>
              <tbody>
                {insuranceClaimEconomics.map((row, i) => (
                  <tr
                    key={row.factor}
                    className={i < insuranceClaimEconomics.length - 1 ? "border-b border-border-subtle" : ""}
                  >
                    <td className="px-5 py-4 font-medium text-ink">{row.factor}</td>
                    <td className="px-5 py-4 font-semibold tabular-nums text-accent">{row.value}</td>
                    <td className="hidden px-5 py-4 text-ink-muted sm:table-cell">{row.revenueImpact}</td>
                    <td className="hidden px-5 py-4 text-ink-muted lg:table-cell">{row.marginImpact}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <HubSection
          id="geography"
          title="Roofing Industry Performance By State"
          subtitle="Relative demand levels — no separate state pages yet."
          className="bg-surface-muted/50"
        >
          <div className="overflow-hidden rounded-2xl border border-border bg-surface">
            <table className="w-full text-sm">
        ...
        <HubSection
          id="calculators"
          title="Roofing Business Calculators"
          subtitle="Run the numbers on revenue, profit margin, crew productivity, and valuation."
          className="bg-surface-muted/50"
        >
          <CalculatorHubGrid items={hubCalculators} />
        </HubSection>

        <HubSection id="startup-costs" title="Roofing Startup Costs" subtitle="Typical investment ranges for launching a roofing company.">
        ...
        <HubSection id="similar-industries" title="Related Home Service Industries">
          <LinkCardGrid items={relatedHomeServiceIndustries} columns={3} />
        </HubSection>

        <section className="border-t border-border/60 bg-surface">
          <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
            <DataSourcesAttribution attribution={roofingAttribution} />
            <p className="mt-6 text-sm text-ink-muted">
