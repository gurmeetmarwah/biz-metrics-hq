...
export const metadata: Metadata = buildIndustryPageMetadata({
  ...
  title: "Cleaning Business Profit Margins (10–20% Typical) | BizMetricsHQ",
  description:
    "Cleaning business profit margins typically run 10–20% net (median ~15%), or about $50K–$100K on $500K revenue. See 2026 owner pay, contracts & valuation benchmarks.",
});
