...
import {
  reportMeta,
  reportSections,
} from "@/lib/industries/food-beverage/bakery-us-industry-report-2026";
...
export default function UsBakingIndustryReportPage() {
  const articleJsonLd = {
        ...
        <div className="border-b border-border/60 bg-surface">
          <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
            <nav aria-label="Breadcrumb" className="text-sm text-ink-faint">
              ...
              <Link href="/industries/food-beverage/bakery/" className="hover:text-accent">
                Bakery
              </Link>
              <span className="mx-2" aria-hidden="true">
                /
