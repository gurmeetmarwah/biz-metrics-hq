...
import { MartialArtsTuitionRevenueCalculator } from "@/components/calculator/MartialArtsTuitionRevenueCalculator";
import { faqs, introContent, meta } from "@/lib/industries/martial-arts-tuition-revenue-calculator";
...
export default function Page() {
  return (
    <CalculatorPageShell
      meta={meta}
      intro={introContent}
      badge="Tuition MRR · autopay · recurring revenue"
      ...
      faqs={faqs}
    >
      <MartialArtsTuitionRevenueCalculator />
    </CalculatorPageShell>
  );
}
