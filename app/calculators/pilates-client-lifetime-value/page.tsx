...
import { PilatesClientLifetimeValueCalculator } from "@/components/calculator/PilatesClientLifetimeValueCalculator";
import { faqs, introContent, meta } from "@/lib/industries/pilates-client-lifetime-value-calculator";
...
export default function Page() {
  return (
    <CalculatorPageShell
      meta={meta}
      intro={introContent}
      badge="ARPU · churn · LTV:CAC ratio"
      ...
      faqs={faqs}
    >
      <PilatesClientLifetimeValueCalculator />
    </CalculatorPageShell>
  );
}
