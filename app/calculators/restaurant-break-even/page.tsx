...
import { RestaurantBreakEvenCalculator } from "@/components/calculator/RestaurantBreakEvenCalculator";
import {
  breakEvenCalculatorMeta,
  breakEvenFaqs,
  introContent,
} from "@/lib/industries/restaurant-break-even-calculator";

export const metadata: Metadata = {
  title: `${breakEvenCalculatorMeta.title} | BizMetricsHQ`,
  description: breakEvenCalculatorMeta.description,
};

export default function RestaurantBreakEvenCalculatorPage() {
  const faqJsonLd = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    mainEntity: breakEvenFaqs.map((faq) => ({
      "@type": "Question",
      name: faq.question,
  ...
  const appJsonLd = {
    "@context": "https://schema.org",
    "@type": "WebApplication",
    name: breakEvenCalculatorMeta.title,
    description: breakEvenCalculatorMeta.description,
        ...
        <section className="hero-mesh border-b border-border/60">
          <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16">
            ...
            >
              ...
              <span className="mx-2">/</span>
              <span className="text-ink-muted">Break-Even Calculator</span>
            </nav>
            ...
            <h1 className="font-display text-3xl font-bold tracking-tight text-ink sm:text-4xl">
              {breakEvenCalculatorMeta.shortTitle}
            </h1>
            <p className="mt-4 max-w-2xl text-base leading-relaxed text-ink-muted sm:text-lg">
              {breakEvenCalculatorMeta.subtitle}
            </p>
