...
import { CrossFitClassCapacityCalculator } from "@/components/calculator/CrossFitClassCapacityCalculator";
import { faqs, introContent, meta } from "@/lib/industries/crossfit-class-capacity-calculator";
...
export default function Page() {
  return (
    <CalculatorPageShell
      ...
      faqs={faqs}
    >
      <CrossFitClassCapacityCalculator />
    </CalculatorPageShell>
  );
}
