...
export function CoffeeShopBenchmarkTool({ thresholds }: { thresholds: Thresholds }) {
  const [revenue, setRevenue] = useState("550000");
  const [customers, setCustomers] = useState("280");
