...
export function StudioUtilizationPanel({
  title,
  subtitle,
  items,
}: {
  ...
  return (
    <BenchmarkTable
      title={title}
      subtitle={subtitle}
      badge="Boutique Fitness Exclusive"
      items={items}
    />
  );
}
...
export function ClientEconomicsDashboard({
  title,
  subtitle,
  items,
  methodologySummary,
...
export function BoutiqueFitnessPerformanceIndex({
  title,
  subtitle,
  data,
}: {
