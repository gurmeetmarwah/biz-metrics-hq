...
type Thresholds = {
  ...
  ordersPerDay: { low: number; median: number; high: number };
};
...
export function BakeryBenchmarkTool({ thresholds }: { thresholds: Thresholds }) {
  ...
  const results = [
    ...
    { label: "Orders/Day", rating: rate(ord, thresholds.ordersPerDay) },
  ];
