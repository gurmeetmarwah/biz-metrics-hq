...
export function StudentRetentionDashboard({
  title,
  subtitle,
  items,
}: {
  ...
  return (
    <BenchmarkTable
      title={title}
      subtitle={subtitle}
      badge="Martial Arts Exclusive"
      items={items}
    />
  );
}

export function ProgramPerformancePanel({
  title,
  subtitle,
  items,
}: {
  ...
  return (
    <BenchmarkTable
      title={title}
      subtitle={subtitle}
      badge="Program Mix Intelligence"
      items={items}
    />
  );
}

export function InstructorProductivityPanel({
  title,
  subtitle,
  items,
}: {
...
export function StudentEconomicsDashboard({
  title,
  subtitle,
  items,
  methodologySummary,
...
export function YouthActivityBenchmarkMatrix({
  title,
  subtitle,
  data,
}: {
...
export { MembershipEconomicsPanel as TuitionEconomicsPanel };
