...
import {
  ...
  nailSalonDataLinks,
  relatedTools,
} from "@/lib/industries/nail-salon-break-even-calculator";

export function NailSalonBreakEvenCalculator() {
  ...
  return (
    <>
      ...
      <NailSalonCalculatorFooter calculatorId="break-even" relatedTools={relatedTools} dataLinks={nailSalonDataLinks} faqs={faqs} />
    </>
  );
}
