...
import {
  ...
  industryBenchmarks,
  relatedTools,
} from "@/lib/industries/hair-salon-chair-utilization-calculator";

export function HairSalonChairUtilizationCalculator() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                {numberField("chairs", "Number of Chairs", "chairs")}
                {numberField("available", "Available Hours / Chair / Week", "availableHoursPerChairPerWeek")}
                {numberField("booked", "Booked Hours / Chair / Week", "bookedHoursPerChairPerWeek", 0)}
            ...
            <div className="flex-1 grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-border bg-surface p-5">
                <p className="text-xs text-ink-faint">Booked Chair Hours / Week</p>
                <p className="mt-1 text-2xl font-bold tabular-nums text-ink">{formatNumber(result.bookedChairHours)}</p>
              </div>
              <div className="rounded-2xl border border-border bg-surface p-5">
              ...
              <div className="rounded-2xl border border-border bg-surface p-5">
                <p className="text-xs text-ink-faint">Upside at 80% Utilization</p>
      ...
      <HairSalonCalculatorFooter calculatorId="chair-utilization" relatedTools={relatedTools} dataLinks={hairSalonDataLinks} faqs={faqs} />
    </>
  );
}
