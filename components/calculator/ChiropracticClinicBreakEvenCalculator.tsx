...
import {
  ...
  industryBenchmarks,
  relatedTools,
} from "@/lib/industries/chiropractic-clinic-break-even-calculator";

export function ChiropracticClinicBreakEvenCalculator() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                <CurrencyInput id="fixed" label="Monthly Fixed Costs" value={inputs.fixedCosts} onChange={(v) => update("fixedCosts", v)} tooltip="Admin payroll, rent, insurance, baseline marketing" />
                <PercentInput id="chiropractor" label="Chiropractor Payroll %" value={inputs.chiropractorPayrollPct} onChange={(v) => update("chiropractorPayrollPct", v)} />
      ...
      <ChiropracticCalculatorFooter calculatorId="break-even" relatedTools={relatedTools} dataLinks={chiropracticDataLinks} faqs={faqs} />
    </>
  );
}
