...
import {
  ...
  relatedTools,
} from "@/lib/industries/medical-spa-membership-revenue-calculator";

export function MedicalSpaMembershipRevenueCalculator() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            ...
            <div className="flex-1 grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-accent/25 bg-accent-soft/30 p-5 sm:col-span-2">
                ...
                <p className="mt-1 font-semibold text-ink">Median ~{formatCurrency(medicalSpaIndustryAverages.membershipMrr)}/mo MRR</p>
      ...
      <MedicalSpaCalculatorFooter calculatorId="membership-revenue" relatedTools={relatedTools} dataLinks={medicalSpaDataLinks} faqs={faqs} />
    </>
  );
}
