...
import {
  ...
  relatedTools,
} from "@/lib/industries/cleaning-business-customer-lifetime-value-calculator";

export function CleaningBusinessCustomerLifetimeValueCalculator() {
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            ...
            <div className="flex-1 grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-accent/25 bg-accent-soft/30 p-5 sm:col-span-2">
                ...
                <p className="mt-1 font-semibold text-ink">$1,200 – $6,000 median LTV</p>
                <p className="mt-1 text-xs text-ink-faint">Median {formatCurrency(cleaningBusinessIndustryAverages.customerLtv)} · 75–85% retention target</p>
              </div>
            </div>
          </div>
        </div>
