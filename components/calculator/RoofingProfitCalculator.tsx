...
import {
  ...
  marginTiers,
  relatedTools,
} from "@/lib/industries/roofing-profit-calculator";

export function RoofingProfitCalculator() {
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                ...
                <CurrencyInput id="labor" label="Crew Labor" value={inputs.crewLabor} onChange={(v) => update("crewLabor", v)} />
                <CurrencyInput id="materials" label="Materials" value={inputs.materials} onChange={(v) => update("materials", v)} />
                <CurrencyInput id="marketing" label="Marketing & Lead Gen" value={inputs.marketing} onChange={(v) => update("marketing", v)} />
            ...
            <div className="flex-1">
              <div className="rounded-2xl border border-border bg-surface-muted/30 p-6 sm:p-8">
                ...
                <div className="mt-6 rounded-xl border border-border bg-surface px-5 py-4">
                  ...
                  <p className="mt-1 font-semibold text-ink">Average Roofing: {roofingIndustryAverages.marginRange}</p>
                  <p className="mt-1 text-xs text-ink-faint">Median {roofingIndustryAverages.marginPct}% · 310+ U.S. Roofing businesses</p>
                </div>
