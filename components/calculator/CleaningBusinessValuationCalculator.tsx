...
import {
  ...
  relatedTools,
} from "@/lib/industries/cleaning-business-valuation-calculator";

export function CleaningBusinessValuationCalculator() {
              ...
              <div className="mt-6 space-y-4">
                ...
                <label htmlFor="multiple" className="block">
                  ...
                  <input id="multiple" type="number" min={1} max={5} step={0.1} value={inputs.sdeMultiple}
                    onChange={(e) => update("sdeMultiple", Number(e.target.value) || 2.4)}
