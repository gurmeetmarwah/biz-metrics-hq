...
import {
  ...
  barbershopDataLinks,
  relatedTools,
} from "@/lib/industries/barbershop-startup-cost-calculator";

export function BarbershopStartupCostCalculator() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                <CurrencyInput id="buildout" label="Buildout & Plumbing" value={inputs.buildout} onChange={(v) => update("buildout", v)} />
                <CurrencyInput id="chairs" label="Barber Chairs & Stations" value={inputs.barberChairs} onChange={(v) => update("barberChairs", v)} />
                <CurrencyInput id="equipment" label="Equipment & Tools" value={inputs.equipmentTools} onChange={(v) => update("equipmentTools", v)} />
      ...
      <BarbershopCalculatorFooter calculatorId="startup-cost" relatedTools={relatedTools} dataLinks={barbershopDataLinks} faqs={faqs} />
    </>
  );
}
