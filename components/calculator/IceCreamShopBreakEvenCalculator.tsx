...
export function IceCreamShopBreakEvenCalculator() {
    ...
    <>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                ...
                <CurrencyInput id="order" label="Average Ticket" value={inputs.averageTicket} onChange={(v) => update("averageTicket", v)} />
      ...
      <section className="border-b border-border/60 bg-surface-muted/50">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <h2 className="font-display text-xl font-semibold text-ink">Ice Cream Shop Benchmarks</h2>
      ...
      <IceCreamShopCalculatorFooter calculatorId="break-even" relatedTools={relatedTools} dataLinks={iceCreamShopDataLinks} faqs={faqs} />
    </>
  );
}
