...
import {
  ...
  marginTiers,
  relatedTools,
} from "@/lib/industries/landscaping-profit-calculator";

export function LandscapingProfitCalculator() {
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                ...
                <CurrencyInput id="materials" label="Materials & Plants" value={inputs.materials} onChange={(v) => update("materials", v)} />
                <CurrencyInput id="fleet" label="Fleet & Equipment" value={inputs.fleet} onChange={(v) => update("fleet", v)} />
            ...
            <div className="flex-1">
              <div className="rounded-2xl border border-border bg-surface-muted/30 p-6 sm:p-8">
                ...
                <div className="mt-6 rounded-xl border border-border bg-surface px-5 py-4">
                  ...
                  <p className="mt-1 font-semibold text-ink">Average Landscaping: {landscapingIndustryAverages.marginRange}</p>
                  <p className="mt-1 text-xs text-ink-faint">Median {landscapingIndustryAverages.marginPct}% · 280+ U.S. Landscaping businesses</p>
                </div>
