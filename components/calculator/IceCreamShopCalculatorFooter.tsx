...
import {
  iceCreamShopAttribution,
  getIceCreamShopCalculatorCalculations,
  type IceCreamShopCalculatorId,
} from "@/lib/data-sources/ice-cream-shop";

export function IceCreamShopCalculatorFooter({
  calculatorId,
  relatedTools,
  dataLinks,
  faqs,
}: {
  calculatorId: IceCreamShopCalculatorId;
      ...
      <section className="border-b border-border/60 bg-surface-muted/50">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <DataSourcesAttribution
            ...
            calculations={getIceCreamShopCalculatorCalculations(calculatorId)}
          />
        </div>
      </section>
      <section className="border-b border-border/60 bg-surface">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <h2 className="font-display text-xl font-semibold text-ink">Related Ice Cream Shop Data</h2>
