...
import {
  getOptometryCalculatorCalculations,
  type OptometryCalculatorId,
} from "@/lib/data-sources/optometry-calculators";
import { optometryPracticeAttribution } from "@/lib/data-sources/optometry-practice";

export function OptometryCalculatorFooter({
  calculatorId,
  relatedTools,
  dataLinks,
  faqs,
}: {
  calculatorId: OptometryCalculatorId;
      ...
      <section className="border-b border-border/60 bg-surface-muted/50">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <DataSourcesAttribution
            ...
            calculations={getOptometryCalculatorCalculations(calculatorId)}
          />
        </div>
      </section>
      <section className="border-b border-border/60 bg-surface">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <h2 className="font-display text-xl font-semibold text-ink">Related Optometry Practice Data</h2>
