...
import {
  foodTruckAttribution,
  getFoodTruckCalculatorCalculations,
  type FoodTruckCalculatorId,
} from "@/lib/data-sources/food-truck";

export function FoodTruckCalculatorFooter({
  calculatorId,
  relatedTools,
  dataLinks,
  faqs,
}: {
  calculatorId: FoodTruckCalculatorId;
      ...
      <section className="border-b border-border/60 bg-surface-muted/50">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <DataSourcesAttribution
            attribution={foodTruckAttribution}
            calculations={getFoodTruckCalculatorCalculations(calculatorId)}
          />
        </div>
      </section>
      <section className="border-b border-border/60 bg-surface">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <h2 className="font-display text-xl font-semibold text-ink">Related Food Truck Data</h2>
