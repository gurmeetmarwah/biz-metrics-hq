...
import {
  ...
  multipleRanges,
  relatedTools,
} from "@/lib/industries/chiropractic-clinic-valuation-calculator";

export function ChiropracticClinicValuationCalculator() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                ...
                <CurrencyInput id="ownerComp" label="Owner Chiropractor Compensation" value={inputs.ownerComp} onChange={(v) => update("ownerComp", v)} />
                ...
                <label htmlFor="multiple" className="block">
                  ...
                  <input id="multiple" type="number" min={1} max={8} step={0.05} value={inputs.sdeMultiple}
                    onChange={(e) => update("sdeMultiple", Number(e.target.value) || 2.8)}
      ...
      <ChiropracticCalculatorFooter calculatorId="valuation" relatedTools={relatedTools} dataLinks={chiropracticDataLinks} faqs={faqs} />
    </>
  );
}
