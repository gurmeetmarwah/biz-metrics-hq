...
import {
  ...
  relatedTools,
} from "@/lib/industries/pilates-membership-revenue-calculator";

export function PilatesMembershipRevenueCalculator() {
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            ...
            <div className="flex-1 grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-accent/25 bg-accent-soft/30 p-5 sm:col-span-2">
                ...
                <p className="mt-1 font-semibold text-ink">Median ~{formatCurrency(pilatesIndustryAverages.mrr)}/mo MRR</p>
                <p className="mt-1 text-xs text-ink-faint">
                  {result.vsBenchmarkMrr >= 0 ? "+" : ""}
                  {formatCurrency(result.vsBenchmarkMrr)} vs median · ~{pilatesIndustryAverages.activeClients} active members
                </p>
              </div>
            </div>
          </div>
