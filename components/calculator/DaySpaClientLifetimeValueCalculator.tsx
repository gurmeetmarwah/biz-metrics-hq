...
import {
  ...
  daySpaDataLinks,
  relatedTools,
} from "@/lib/industries/day-spa-client-lifetime-value-calculator";

export function DaySpaClientLifetimeValueCalculator() {
  ...
  return (
    <>
      ...
      <DaySpaCalculatorFooter calculatorId="client-lifetime-value" relatedTools={relatedTools} dataLinks={daySpaDataLinks} faqs={faqs} />
    </>
  );
}
