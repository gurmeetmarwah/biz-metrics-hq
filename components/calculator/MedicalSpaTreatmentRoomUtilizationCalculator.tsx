...
import {
  ...
  medicalSpaDataLinks,
  relatedTools,
} from "@/lib/industries/medical-spa-treatment-room-utilization-calculator";

export function MedicalSpaTreatmentRoomUtilizationCalculator() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                {numberField("rooms", "Treatment Rooms", "treatmentRooms")}
                {numberField("available", "Available Hours / Room / Week", "availableHoursPerRoomPerWeek")}
                {numberField("booked", "Booked Hours / Room / Week", "bookedHoursPerRoomPerWeek")}
            ...
            <div className="flex-1 grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border border-border bg-surface p-5 sm:col-span-2">
                <p className="text-sm text-ink-muted">Room Utilization</p>
              ...
              <div className="rounded-2xl border border-border bg-surface p-5">
                <p className="text-xs text-ink-faint">Revenue Upside (to 75%)</p>
      ...
      <MedicalSpaCalculatorFooter calculatorId="treatment-room-utilization" relatedTools={relatedTools} dataLinks={medicalSpaDataLinks} faqs={faqs} />
    </>
  );
}
