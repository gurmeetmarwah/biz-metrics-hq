...
import {
  ...
  industryBenchmarks,
  relatedTools,
} from "@/lib/industries/hvac-break-even-calculator";

export function HvacBreakEvenCalculator() {
    ...
    <>
            ...
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                ...
                <label htmlFor="techs" className="block">
                  ...
                  <input id="techs" type="number" min={1} max={50} value={inputs.technicians} onChange={(e) => update("technicians", Number(e.target.value) || 8)}
                    className="mt-1.5 w-full rounded-xl border border-border bg-surface px-4 py-3 text-sm tabular-nums text-ink focus:border-accent focus:outline-none focus:ring-4 focus:ring-accent/10" />
                </label>
      ...
      <section className="border-b border-border/60 bg-surface-muted/50">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <h2 className="font-display text-xl font-semibold text-ink">HVAC Benchmarks</h2>
