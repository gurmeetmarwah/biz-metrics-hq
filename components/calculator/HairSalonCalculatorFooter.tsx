...
import {
  getHairSalonCalculatorCalculations,
  type HairSalonCalculatorId,
} from "@/lib/data-sources/hair-salon-calculators";
import { hairSalonAttribution } from "@/lib/data-sources/hair-salon";

export function HairSalonCalculatorFooter({
  calculatorId,
  relatedTools,
  dataLinks,
  faqs,
}: {
  calculatorId: HairSalonCalculatorId;
      ...
      <section className="border-b border-border/60 bg-surface-muted/50">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <DataSourcesAttribution
            attribution={hairSalonAttribution}
            calculations={getHairSalonCalculatorCalculations(calculatorId)}
          />
        </div>
      </section>
      <section className="border-b border-border/60 bg-surface">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <h2 className="font-display text-xl font-semibold text-ink">Related Hair Salon Data</h2>
