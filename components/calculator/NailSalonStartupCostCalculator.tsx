...
import {
  ...
  nailSalonDataLinks,
  relatedTools,
} from "@/lib/industries/nail-salon-startup-cost-calculator";

export function NailSalonStartupCostCalculator() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                ...
                <CurrencyInput id="ventilation" label="Ventilation System" value={inputs.ventilation} onChange={(v) => update("ventilation", v)} />
      ...
      <NailSalonCalculatorFooter calculatorId="startup-cost" relatedTools={relatedTools} dataLinks={nailSalonDataLinks} faqs={faqs} />
    </>
  );
}
