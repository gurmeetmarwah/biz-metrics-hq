...
import {
  getDaySpaCalculatorCalculations,
  type DaySpaCalculatorId,
} from "@/lib/data-sources/day-spa-calculators";
import { daySpaAttribution } from "@/lib/data-sources/day-spa";

export function DaySpaCalculatorFooter({
  calculatorId,
  relatedTools,
  dataLinks,
  faqs,
}: {
  calculatorId: DaySpaCalculatorId;
      ...
      <section className="border-b border-border/60 bg-surface-muted/50">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <DataSourcesAttribution
            attribution={daySpaAttribution}
            calculations={getDaySpaCalculatorCalculations(calculatorId)}
          />
        </div>
      </section>
      <section className="border-b border-border/60 bg-surface">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <h2 className="font-display text-xl font-semibold text-ink">Related Day Spa Data</h2>
