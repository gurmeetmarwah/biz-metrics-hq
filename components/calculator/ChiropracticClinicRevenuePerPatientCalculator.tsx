...
import {
  ...
  patientBenchmarks,
  relatedTools,
} from "@/lib/industries/chiropractic-clinic-revenue-per-patient-calculator";

export function ChiropracticClinicRevenuePerPatientCalculator() {
              ...
              <div className="mt-6 space-y-4">
                <label htmlFor="patients" className="block">
                  ...
                  <input
                    ...
                    onChange={(e) => update("activePatients", Number(e.target.value) || 950)}
