...
import {
  ...
  formatPercent,
  relatedTools,
} from "@/lib/industries/physical-therapy-clinic-ebitda-calculator";

export function PhysicalTherapyClinicEbitdaCalculator() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                ...
                <CurrencyInput id="therapist" label="Therapist Payroll" value={inputs.therapistPayroll} onChange={(v) => update("therapistPayroll", v)} />
                <CurrencyInput id="admin" label="Admin Staff" value={inputs.adminStaff} onChange={(v) => update("adminStaff", v)} />
                <CurrencyInput id="supplies" label="Supplies" value={inputs.supplies} onChange={(v) => update("supplies", v)} />
      ...
      <PhysicalTherapyCalculatorFooter calculatorId="ebitda" relatedTools={relatedTools} dataLinks={physicalTherapyDataLinks} faqs={faqs} />
    </>
  );
}
