...
import {
  ...
  nailSalonDataLinks,
  relatedTools,
} from "@/lib/industries/nail-salon-profit-margin-calculator";

export function NailSalonProfitMarginCalculator() {
  ...
  return (
    <>
      ...
      <NailSalonCalculatorFooter calculatorId="profit-margin" relatedTools={relatedTools} dataLinks={nailSalonDataLinks} faqs={faqs} />
    </>
  );
}
