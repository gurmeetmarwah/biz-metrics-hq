...
import {
  ...
  formatPercent,
  relatedTools,
} from "@/lib/industries/veterinary-clinic-ebitda-calculator";

export function VeterinaryClinicEbitdaCalculator() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                ...
                <CurrencyInput id="vet" label="Veterinarian Payroll" value={inputs.vetPayroll} onChange={(v) => update("vetPayroll", v)} />
                <CurrencyInput id="support" label="Support Staff" value={inputs.supportStaff} onChange={(v) => update("supportStaff", v)} />
                <CurrencyInput id="supplies" label="Medical Supplies" value={inputs.medicalSupplies} onChange={(v) => update("medicalSupplies", v)} />
      ...
      <VeterinaryCalculatorFooter calculatorId="ebitda" relatedTools={relatedTools} dataLinks={veterinaryDataLinks} faqs={faqs} />
    </>
  );
}
