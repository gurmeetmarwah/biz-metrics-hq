...
import {
  ...
  industryBenchmarks,
  relatedTools,
} from "@/lib/industries/hair-salon-payroll-percentage-calculator";

export function HairSalonPayrollPercentageCalculator() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                ...
                <CurrencyInput id="stylist" label="Stylist Payroll & Commissions" value={inputs.stylistPayroll} onChange={(v) => update("stylistPayroll", v)} />
                <CurrencyInput id="frontdesk" label="Front-desk & Support Payroll" value={inputs.frontDeskPayroll} onChange={(v) => update("frontDeskPayroll", v)} />
            ...
            <div className="flex-1 grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border border-border bg-surface p-5 sm:col-span-2">
                ...
                <p className="mt-2 text-sm capitalize text-ink-muted">Labor cost status: {result.status}</p>
              </div>
      ...
      <HairSalonCalculatorFooter calculatorId="payroll-percentage" relatedTools={relatedTools} dataLinks={hairSalonDataLinks} faqs={faqs} />
    </>
  );
}
