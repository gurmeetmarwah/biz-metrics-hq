...
import {
  ...
  daySpaDataLinks,
  relatedTools,
} from "@/lib/industries/day-spa-startup-cost-calculator";

export function DaySpaStartupCostCalculator() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                ...
                <CurrencyInput id="tables" label="Massage Tables & Equipment" value={inputs.massageTables} onChange={(v) => update("massageTables", v)} />
                <CurrencyInput id="furniture" label="Furniture & Fixtures" value={inputs.furnitureFixtures} onChange={(v) => update("furnitureFixtures", v)} />
                <CurrencyInput id="inventory" label="Skincare & Product Inventory" value={inputs.skincareInventory} onChange={(v) => update("skincareInventory", v)} />
      ...
      <DaySpaCalculatorFooter calculatorId="startup-cost" relatedTools={relatedTools} dataLinks={daySpaDataLinks} faqs={faqs} />
    </>
  );
}
