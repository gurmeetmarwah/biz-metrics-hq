...
import {
  ...
  medicalSpaDataLinks,
  relatedTools,
} from "@/lib/industries/medical-spa-ebitda-calculator";

export function MedicalSpaEbitdaCalculator() {
  ...
  return (
    <>
      ...
      <MedicalSpaCalculatorFooter calculatorId="ebitda" relatedTools={relatedTools} dataLinks={medicalSpaDataLinks} faqs={faqs} />
    </>
  );
}
