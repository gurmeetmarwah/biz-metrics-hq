...
import {
  chiropracticAttribution,
  getChiropracticCalculatorCalculations,
  type ChiropracticCalculatorId,
} from "@/lib/data-sources/chiropractic";

export function ChiropracticCalculatorFooter({
  calculatorId,
  relatedTools,
  dataLinks,
  faqs,
}: {
  calculatorId: ChiropracticCalculatorId;
      ...
      <section className="border-b border-border/60 bg-surface-muted/50">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <DataSourcesAttribution
            attribution={chiropracticAttribution}
            calculations={getChiropracticCalculatorCalculations(calculatorId)}
          />
        </div>
      </section>
      <section className="border-b border-border/60 bg-surface">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <h2 className="font-display text-xl font-semibold text-ink">Related Chiropractic Clinic Data</h2>
