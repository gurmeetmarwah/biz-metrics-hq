...
import {
  getNailSalonCalculatorCalculations,
  type NailSalonCalculatorId,
} from "@/lib/data-sources/nail-salon-calculators";
import { nailSalonAttribution } from "@/lib/data-sources/nail-salon";

export function NailSalonCalculatorFooter({
  calculatorId,
  relatedTools,
  dataLinks,
  faqs,
}: {
  calculatorId: NailSalonCalculatorId;
      ...
      <section className="border-b border-border/60 bg-surface-muted/50">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <DataSourcesAttribution
            attribution={nailSalonAttribution}
            calculations={getNailSalonCalculatorCalculations(calculatorId)}
          />
        </div>
      </section>
      <section className="border-b border-border/60 bg-surface">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <h2 className="font-display text-xl font-semibold text-ink">Related Nail Salon Data</h2>
