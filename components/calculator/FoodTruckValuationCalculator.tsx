...
export function FoodTruckValuationCalculator() {
  ...
  return (
    <>
            ...
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                ...
                <label htmlFor="multiple" className="block">
                  ...
                  <input id="multiple" type="number" min={1} max={5} step={0.05} value={inputs.sdeMultiple}
                    onChange={(e) => update("sdeMultiple", Number(e.target.value) || 2.25)}
      ...
      <FoodTruckCalculatorFooter calculatorId="valuation" relatedTools={relatedTools} dataLinks={foodTruckDataLinks} faqs={faqs} />
    </>
  );
}
