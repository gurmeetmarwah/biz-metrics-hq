...
import {
  ...
  marginTiers,
  relatedTools,
} from "@/lib/industries/electrical-profit-margin-calculator";

export function ElectricalProfitMarginCalculator() {
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                ...
                <CurrencyInput id="payroll" label="Electrician Payroll" value={inputs.technicianPayroll} onChange={(v) => update("technicianPayroll", v)} />
            ...
            <div className="flex-1">
              <div className="rounded-2xl border border-border bg-surface-muted/30 p-6 sm:p-8">
                ...
                <div className="mt-6 rounded-xl border border-border bg-surface px-5 py-4">
                  ...
                  <p className="mt-1 font-semibold text-ink">Average Electrical: {electricalIndustryAverages.marginRange}</p>
                  <p className="mt-1 text-xs text-ink-faint">Median {electricalIndustryAverages.marginPct}% · 380+ U.S. Electrical businesses</p>
                </div>
