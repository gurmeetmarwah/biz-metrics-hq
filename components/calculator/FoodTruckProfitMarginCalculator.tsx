...
export function FoodTruckProfitMarginCalculator() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                ...
                <CurrencyInput id="food" label="Food Costs" value={inputs.foodCosts} onChange={(v) => update("foodCosts", v)} />
                <CurrencyInput id="labor" label="Labor Costs" value={inputs.laborCosts} onChange={(v) => update("laborCosts", v)} />
                <CurrencyInput id="commissary" label="Commissary / Rent" value={inputs.commissaryCosts} onChange={(v) => update("commissaryCosts", v)} />
                <CurrencyInput id="fuel" label="Fuel & Vehicle" value={inputs.fuelCosts} onChange={(v) => update("fuelCosts", v)} />
            ...
            <div className="flex-1">
              <div className="rounded-2xl border border-border bg-surface-muted/30 p-6 sm:p-8">
                ...
                <div className="mt-6 rounded-xl border border-border bg-surface px-5 py-4">
                  ...
                  <p className="mt-1 font-semibold text-ink">Average Food Truck: {foodTruckIndustryAverages.marginRange}</p>
      ...
      <FoodTruckCalculatorFooter calculatorId="profit-margin" relatedTools={relatedTools} dataLinks={foodTruckDataLinks} faqs={faqs} />
    </>
  );
}
