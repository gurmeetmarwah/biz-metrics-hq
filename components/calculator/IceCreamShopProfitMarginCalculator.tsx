...
export function IceCreamShopProfitMarginCalculator() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                ...
                <CurrencyInput id="foods" label="Food Costs" value={inputs.foodCosts} onChange={(v) => update("foodCosts", v)} />
            ...
            <div className="flex-1">
              <div className="rounded-2xl border border-border bg-surface-muted/30 p-6 sm:p-8">
                ...
                <div className="mt-6 rounded-xl border border-border bg-surface px-5 py-4">
                  ...
                  <p className="mt-1 font-semibold text-ink">Industry Average: {iceCreamShopIndustryAverages.marginRange}</p>
      ...
      <IceCreamShopCalculatorFooter calculatorId="profit-margin" relatedTools={relatedTools} dataLinks={iceCreamShopDataLinks} faqs={faqs} />
    </>
  );
}
