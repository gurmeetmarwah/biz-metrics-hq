...
import {
  ...
  relatedTools,
} from "@/lib/industries/plumbing-revenue-per-technician-calculator";

export function PlumbingRevenuePerTechnicianCalculator() {
    ...
    <>
              ...
              <div className="mt-6 space-y-4">
                ...
                <label htmlFor="technicians" className="block">
                  ...
                  <input
                    ...
                    onChange={(e) => update("technicians", Number(e.target.value) || 6)}
            ...
            <div className="flex-1 grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-accent/25 bg-accent-soft/30 p-5 sm:col-span-2">
                ...
                <p className="mt-1 font-semibold text-ink">
                  {plumbingIndustryAverages.revenuePerTechnicianRange}
                </p>
                <p className="mt-1 text-xs text-ink-faint">
                  Median {formatCurrency(plumbingIndustryAverages.revenuePerTechnician)} · 380+ Plumbing businesses
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="border-b border-border/60 bg-surface-muted/50">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <h2 className="font-display text-xl font-semibold text-ink">Plumbing Productivity Benchmarks</h2>
