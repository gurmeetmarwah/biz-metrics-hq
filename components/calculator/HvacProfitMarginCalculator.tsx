...
import {
  ...
  marginTiers,
  relatedTools,
} from "@/lib/industries/hvac-profit-margin-calculator";

export function HvacProfitMarginCalculator() {
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                ...
                <CurrencyInput id="materials" label="Materials & Equipment" value={inputs.materials} onChange={(v) => update("materials", v)} />
            ...
            <div className="flex-1">
              <div className="rounded-2xl border border-border bg-surface-muted/30 p-6 sm:p-8">
                ...
                <div className="mt-6 rounded-xl border border-border bg-surface px-5 py-4">
                  ...
                  <p className="mt-1 font-semibold text-ink">Average HVAC: {hvacIndustryAverages.marginRange}</p>
                  <p className="mt-1 text-xs text-ink-faint">Median {hvacIndustryAverages.marginPct}% · 420+ U.S. HVAC businesses</p>
                </div>
