...
import {
  ...
  daySpaDataLinks,
  relatedTools,
} from "@/lib/industries/day-spa-payroll-percentage-calculator";

export function DaySpaPayrollPercentageCalculator() {
  ...
  return (
    <>
      ...
      <DaySpaCalculatorFooter calculatorId="payroll-percentage" relatedTools={relatedTools} dataLinks={daySpaDataLinks} faqs={faqs} />
    </>
  );
}
