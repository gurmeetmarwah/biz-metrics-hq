...
import { formatPercent, yogaDataLinks } from "@/lib/industries/yoga-calculators-shared";
import {
  ...
  relatedTools,
} from "@/lib/industries/yoga-instructor-productivity-calculator";

export function YogaInstructorProductivityCalculator() {
            ...
            <div className="flex-1 grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-accent/25 bg-accent-soft/30 p-5 sm:col-span-2">
                ...
                <p className="mt-1 text-xs text-ink-faint">
                  ...
                  {formatCurrency(result.vsBenchmark)} vs ~{formatCurrency(yogaIndustryAverages.revenuePerInstructorAnnual)} median
                </p>
              </div>
            </div>
          </div>
