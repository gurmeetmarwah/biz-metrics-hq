...
} from "@/lib/industries/yoga-class-capacity-calculator";

export function YogaClassCapacityCalculator() {
        ...
        <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <p className="mt-1 text-sm text-ink-muted">Model class revenue from fill rate and studio capacity.</p>
            ...
            <div className="flex-1 grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-accent/25 bg-accent-soft/30 p-5 sm:col-span-2">
                ...
                <p className="mt-1 font-semibold text-ink">
                  ~{formatCurrency(yogaIndustryAverages.revenuePerClass)}/class · {yogaIndustryAverages.avgOccupancyPct}% avg occupancy
                </p>
