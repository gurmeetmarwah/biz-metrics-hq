...
import {
  ...
  barbershopDataLinks,
  relatedTools,
} from "@/lib/industries/barbershop-profit-margin-calculator";

export function BarbershopProfitMarginCalculator() {
  ...
  return (
    <>
      ...
      <BarbershopCalculatorFooter calculatorId="profit-margin" relatedTools={relatedTools} dataLinks={barbershopDataLinks} faqs={faqs} />
    </>
  );
}
