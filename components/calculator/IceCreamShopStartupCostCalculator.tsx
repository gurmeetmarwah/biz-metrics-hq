...
export function IceCreamShopStartupCostCalculator() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                ...
                <CurrencyInput id="freezers" label="Freezers" value={inputs.freezers} onChange={(v) => update("freezers", v)} />
                <CurrencyInput id="furniture" label="Furniture" value={inputs.furniture} onChange={(v) => update("furniture", v)} />
                ...
                <CurrencyInput id="permits" label="Licenses & Permits" value={inputs.permits} onChange={(v) => update("permits", v)} />
      ...
      <IceCreamShopCalculatorFooter calculatorId="startup-cost" relatedTools={relatedTools} dataLinks={iceCreamShopDataLinks} faqs={faqs} />
    </>
  );
}
