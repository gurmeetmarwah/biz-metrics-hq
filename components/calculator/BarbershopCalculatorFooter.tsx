...
import {
  getBarbershopCalculatorCalculations,
  type BarbershopCalculatorId,
} from "@/lib/data-sources/barbershop-calculators";
import { barbershopAttribution } from "@/lib/data-sources/barbershop";

export function BarbershopCalculatorFooter({
  calculatorId,
  relatedTools,
  dataLinks,
  faqs,
}: {
  calculatorId: BarbershopCalculatorId;
      ...
      <section className="border-b border-border/60 bg-surface-muted/50">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <DataSourcesAttribution
            attribution={barbershopAttribution}
            calculations={getBarbershopCalculatorCalculations(calculatorId)}
          />
        </div>
      </section>
      <section className="border-b border-border/60 bg-surface">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <h2 className="font-display text-xl font-semibold text-ink">Related Barbershop Data</h2>
