...
export function PilatesCalculatorFooter({
  relatedTools,
  dataLinks,
  faqs,
}: {
    ...
    <>
      <section className="border-b border-border/60 bg-surface">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <h2 className="font-display text-xl font-semibold text-ink">Related Pilates Data</h2>
...
export function PilatesNumberInput({
  id,
  label,
  value,
  onChange,
