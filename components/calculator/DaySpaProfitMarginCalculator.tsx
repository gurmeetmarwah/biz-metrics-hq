...
import {
  ...
  daySpaDataLinks,
  relatedTools,
} from "@/lib/industries/day-spa-profit-margin-calculator";

export function DaySpaProfitMarginCalculator() {
  ...
  return (
    <>
      ...
      <DaySpaCalculatorFooter calculatorId="profit-margin" relatedTools={relatedTools} dataLinks={daySpaDataLinks} faqs={faqs} />
    </>
  );
}
