...
export function DentalPracticeValuationCalculator() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              ...
              <div className="mt-6 space-y-4">
                <CurrencyInput id="revenue" label="Annual Collections" value={inputs.revenue} onChange={(v) => update("revenue", v)} />
                <CurrencyInput id="profit" label="Net Profit" value={inputs.netProfit} onChange={(v) => update("netProfit", v)} />
                <CurrencyInput id="ownerComp" label="Owner Doctor Compensation" value={inputs.ownerComp} onChange={(v) => update("ownerComp", v)} />
                ...
                <label htmlFor="multiple" className="block">
                  ...
                  <input id="multiple" type="number" min={1} max={8} step={0.05} value={inputs.sdeMultiple}
                    onChange={(e) => update("sdeMultiple", Number(e.target.value) || 3.8)}
      ...
      <DentalCalculatorFooter calculatorId="valuation" relatedTools={relatedTools} dataLinks={dentalDataLinks} faqs={faqs} />
    </>
  );
}
