...
import {
  ...
  medicalSpaDataLinks,
  relatedTools,
} from "@/lib/industries/medical-spa-revenue-per-treatment-room-calculator";

export function MedicalSpaRevenuePerTreatmentRoomCalculator() {
  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div className="flex-1 lg:max-w-md">
              <h2 className="font-display text-lg font-semibold text-ink">Room Productivity Inputs</h2>
      ...
      <MedicalSpaCalculatorFooter calculatorId="revenue-per-treatment-room" relatedTools={relatedTools} dataLinks={medicalSpaDataLinks} faqs={faqs} />
    </>
  );
}
