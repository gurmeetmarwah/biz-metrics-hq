...
import {
  getMedicalSpaCalculatorCalculations,
  type MedicalSpaCalculatorId,
} from "@/lib/data-sources/medical-spa-calculators";
import { medicalSpaAttribution } from "@/lib/data-sources/medical-spa";

export function MedicalSpaCalculatorFooter({
  calculatorId,
  relatedTools,
  dataLinks,
  faqs,
}: {
  calculatorId: MedicalSpaCalculatorId;
      ...
      <section className="border-b border-border/60 bg-surface-muted/50">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <DataSourcesAttribution
            attribution={medicalSpaAttribution}
            calculations={getMedicalSpaCalculatorCalculations(calculatorId)}
          />
        </div>
      </section>
      <section className="border-b border-border/60 bg-surface">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <h2 className="font-display text-xl font-semibold text-ink">Related Medical Spa Data</h2>
