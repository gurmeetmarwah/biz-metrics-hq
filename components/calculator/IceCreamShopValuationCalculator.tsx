...
export function IceCreamShopValuationCalculator() {
  ...
  return (
    <>
      ...
      <IceCreamShopCalculatorFooter calculatorId="valuation" relatedTools={relatedTools} dataLinks={iceCreamShopDataLinks} faqs={faqs} />
    </>
  );
}
