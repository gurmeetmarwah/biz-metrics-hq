...
export function CoffeeShopProfitMarginCalculator() {
            ...
            <div className="flex-1">
              <div className="rounded-2xl border border-border bg-surface-muted/30 p-6 sm:p-8">
                ...
                <div className="mt-6 rounded-xl border border-border bg-surface px-5 py-4">
                  ...
                  <p className="mt-1 font-semibold text-ink">Average Cafe: {coffeeShopIndustryAverages.marginRange}</p>
                  <p className="mt-1 text-xs text-ink-faint">Median {coffeeShopIndustryAverages.marginPct}% · 290+ U.S. cafes</p>
                </div>
